    ...
    <>
      <style>{`
        ...
        .glass-card:hover {
          ...
          box-shadow: 0 20px 40px -5px rgba(0,0,0,0.1), 0 0 15px var(--color-primary);
          z-index: 10;
        }
      ...
      <div className="bento-container w-full p-2">
        {props.widgets.length === 0 ? (
           <div className="flex flex-col items-center justify-center min-h-[400px] glass-card animate-enter p-10 text-center">
             ...
             <p className="text-[var(--color-text-muted)] max-w-md mx-auto">
               אנא הזן שאלה בתיבת הטקסט למעלה כדי ליצור ויזואליזציות מרהיבות בזמן אמת.
             </p>
           </div>
        ) : (
              ...
              return (
                <div 
                  ...
                  style={{ 
                    ...
                    // but capping it so long lists don't take forever.
